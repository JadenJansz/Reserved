...
const OldReservationCard = ({ reservation }) => {
  return (
    <div className='m-4 bg-teal-100 rounded-xl'>
          <div className='flex ml-10 pt-4'>
            ...
            <h1 className='text-lg font-semibold text-teal-600 mb-2 mt-2 ml-2'>{reservation.ReservationID}</h1>
          </div>
          ...
          <h1 className='text-base font-semibold text-teal-600 text-center px-2 mt-8 pb-6'>Reservation completed</h1>
...
export default OldReservationCard