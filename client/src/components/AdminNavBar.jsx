...
const AdminNavBar = () => {
  return (
    <div>
        <div className="w-max h-28 flex justify-between space-x-72 ml-16 pt-4 fixed bg-white z-10 pr-8">
            <h1 className='w-96 text-3xl font-bold text-gray-700 mt-4'>View Restaurant</h1>
